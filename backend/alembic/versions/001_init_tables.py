...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("weak_subjects", sa.JSON, default=list),
    ...
    op.create_table(
        ...
        sa.Column("knowledge_tags", sa.JSON, default=list),
        sa.Column("difficulty", sa.Integer, default=3),
        sa.Column("content", sa.Text, nullable=False),
        sa.Column("image_url", sa.String(500), default=""),
        sa.Column("solution_steps", sa.JSON, default=list),
    ...
    op.create_table(
        ...
        sa.Column("weak_points", sa.JSON, default=list),
